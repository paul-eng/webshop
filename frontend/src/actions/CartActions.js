...
export const saveCart = (token) => (dispatch, getState) => {
  ...
  return axios
    .post("https://restfulgoods.herokuapp.com/api/carts", cart, { headers })
    .then((res) => {
...
export const fetchCart = (token) => (dispatch) => {
  const headers = { "x-access-token": token };
  return axios
    .get("https://restfulgoods.herokuapp.com/api/carts/session", { headers })
...
export const checkQty =
  ...
  (dispatch) => {
    return axios
      .get("https://restfulgoods.herokuapp.com/api/items/" + pathname)
      .then((res) => {
        let storeQty = matchStock(res.data.stock, type).qty;
        return qty > storeQty;
      });
...
export const saveGuest = () => (dispatch, getState) => {
  return axios
    .post("https://restfulgoods.herokuapp.com/api/carts/guest", { cart: getState().cart })
    .then((res) => {
...
export const fetchGuest = (cartToken) => (dispatch) => {
  ...
  return axios
    .get("https://restfulgoods.herokuapp.com/api/carts/guest", { headers })
    .then(({ data }) => {
...
export const fetchStripe = (amt) => (dispatch, getState) => {
  ...
  return axios
    .post("https://restfulgoods.herokuapp.com/api/checkout", { amt, lineitems })
    .then((res) => {
...
export const fetchCard = (paymethod) => (dispatch) => {
  return axios
    .get("https://restfulgoods.herokuapp.com/api/checkout/" + paymethod)
